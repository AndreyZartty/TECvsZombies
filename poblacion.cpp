...
void Poblacion::nuevageneracion(){
    ...
    for (int i=0; i <8; i+=2){
        ...
        cout<< "Se ha creado el estudiante: "<< estudiante->getNombre() <<" gen: "<<getGeneracion()<<" vida: "<<estudiante->getVida()<< " hijo de: "<< estudiante->getNombrePadre1() << " y " << estudiante->getNombrePadre2() <<endl;
    }
